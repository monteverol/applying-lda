...
const Games = () => {
    ...
    const type = location.pathname.slice(1);  // Extract the type (e.g., "games")

    // Load playlists from the backend when the component mounts
    useEffect(() => {
    ...
    const handleGenerate = (playlistName, newItems) => {
        const newPlaylist = {
            ...
            type: type,  // Use the type from the path (e.g., "games")
        ...
        axios.post('http://127.0.0.1:5000/api/save-playlist', newPlaylist)
            .then(() => {
                ...
                setSelectedPlaylist(newPlaylist);  // Select the newly generated playlist
    ...
    return (
        <div className="games snap-y snap-mandatory h-screen w-full overflow-y-scroll">
            ...
            <div className="h-screen w-full snap-center p-16 flex flex-col gap-8">
                <h1 className="text-[#CFCFCF] text-6xl font-bold">Generated Playlists: Games</h1>
